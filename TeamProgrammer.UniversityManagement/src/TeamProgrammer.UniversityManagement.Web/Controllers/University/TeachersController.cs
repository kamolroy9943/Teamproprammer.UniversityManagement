...
namespace TeamProgrammer.UniversityManagement.Web.Controllers.University
{
    public class TeachersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TeacherId,TeacherName,Email,DesignationId,JoinDate,ContactNo,CreditToBeTaken,DepartmentId")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TeacherId,TeacherName,Email,DesignationId,JoinDate,ContactNo,CreditToBeTaken,DepartmentId")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
